...
const (
	Ping_GetPing_FullMethodName = "/api.ping.Ping/GetPing"
)
...
type PingClient interface {
	GetPing(ctx context.Context, in *GetPingRequest, opts ...grpc.CallOption) (*GetPingReply, error)
}
...
func (c *pingClient) GetPing(ctx context.Context, in *GetPingRequest, opts ...grpc.CallOption) (*GetPingReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPingReply)
	err := c.cc.Invoke(ctx, Ping_GetPing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingServer) GetPing(context.Context, *GetPingRequest) (*GetPingReply, error) {
...
func _Ping_GetPing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ping_GetPing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServer).GetPing(ctx, req.(*GetPingRequest))
	}
